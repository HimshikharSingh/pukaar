...
(function (t, i, e) {
  function s(t, i) {
    (this.element = t), (this.layers = t.getElementsByClassName("scene-layer"));
    var e = {
  ...
  (s.prototype.extend = function () {
    ...
    (s.prototype.offset = function (t) {
      for (var i = 0, e = 0; t && !isNaN(t.offsetLeft) && !isNaN(t.offsetTop); )
      ...
      switch (s) {
        ...
        case "3D":
          o &&
            ...
            (a = t.getComputedStyle(n).getPropertyValue(h)),
            (r = a !== e && a.length > 0 && "none" !== a),
    ...
    (s.prototype.motionSupport = t.DeviceMotionEvent !== e),
    (s.prototype.orientationSupport = t.DeviceOrientationEvent !== e),
    ...
    (s.prototype.css = function (t, i, s) {
      for (var n = null, o = 0, a = this.vendors.length; a > o; o++)
        if (
          ((n =
            null !== this.vendors[o]
    ...
    (s.prototype.onAnimationFrame = function () {
      ...
      (Math.abs(t) > this.calibrationThreshold ||
        ...
        this.portrait
          ? ((this.mx = (this.calibrateX ? i : this.iy) * this.scalarX),
            (this.my = (this.calibrateY ? t : this.ix) * this.scalarY))
          : ((this.mx = (this.calibrateX ? t : this.ix) * this.scalarX),
            (this.my = (this.calibrateY ? i : this.iy) * this.scalarY)),
  ...
  (function () {
    for (
      ...
      i.length > e && !window.requestAnimationFrame;
      ++e
    )
